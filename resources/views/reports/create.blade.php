...
function displayFileList(files) {
    ...
    Array.from(files).forEach((file) => {
        ...
        div.className = 'flex items-center justify-between p-3 bg-[#65B741]/10 rounded-lg';
        div.innerHTML = `
...
function highlight(e) {
    dropZone.classList.add('border-[#65B741]', 'bg-[#65B741]/20');
}

function unhighlight(e) {
    dropZone.classList.remove('border-[#65B741]', 'bg-[#65B741]/20');
}
