...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="padding-top: 6rem !important; padding-bottom: 2rem;">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ (session('user') && in_array(session('user')['role'] ?? '', ['employee', 'admin'])) ? route('staff.announcements') : route('announcements.index') }}" class="inline-flex items-center space-x-2 text-gray-600 hover:text-gray-900">
