...
@section('title', 'Create FAQ - Staff Dashboard')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" style="padding-top: 6rem !important; padding-bottom: 2rem;">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">Create FAQ</h1>
    ...
    <form action="{{ route('staff.faqs.store') }}" method="POST" class="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        @csrf
