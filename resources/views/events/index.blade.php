...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="padding-top: 6rem !important; padding-bottom: 2rem;">
    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-10">
            ...
            <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                <div class="text-3xl font-bold text-[#FFB534] mb-1">3</div>
                <div class="text-sm font-medium text-gray-600">Upcoming</div>
            </div>
            <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                <div class="text-3xl font-bold text-gray-700 mb-1">9</div>
                <div class="text-sm font-medium text-gray-600">Past Events</div>
            </div>
        </div>
    </div>
