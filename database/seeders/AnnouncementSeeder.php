...
class AnnouncementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Get employee profiles for posted_by
        $employees = Profile::whereIn('role', ['employee', 'admin'])->get();
        $employeeIds = $employees->pluck('id')->toArray();
        $postedBy = !empty($employeeIds) ? $employeeIds[array_rand($employeeIds)] : null;
        ...
        $announcements = [
            ...
            [
                ...
                'urgent' => false,
                'start_date' => Carbon::now()->addDays(18)->setTime(18, 0),
            ...
            [
                ...
                'urgent' => false,
                'start_date' => Carbon::now()->setTime(8, 0),
            ...
            [
                ...
                'urgent' => false,
                'start_date' => Carbon::now()->addDays(7)->setTime(0, 0),
                'end_date' => null,
            ],
        ];
        ...
        foreach ($announcements as $index => $announcementData) {
            try {
                Announcement::create([
                    ...
                    'full_content' => $announcementData['full_content'],
                ...
                $this->command->info('✓ Created: ' . $announcementData['title']);
            } catch (\Exception $e) {
                $this->command->error('✗ Failed to create: ' . $announcementData['title']);
